<template>
    <div>
        <br>
        <q-btn color="deep-orange-5" size="sm" icon="add" label="Tambah Data"  @click="mdl_add=true"/>
        <hr class="hrpagin">
        ...
        <div class="tbl_responsive">
            <table width="100%">
                ...
                <tr class="h_table_body"  v-for="(data, index) in list_data" :key="data.id">
                    ...
                    <td class=" h_top">
                        {{data.nama}}
                        <div class="h_nip">({{ data.status_keluarga }})</div>
                    </td>
                    <td class=" h_top">{{data.tpt_lahir}}, {{data.tgl_lahir}}</td>
                    <td class=" h_top">
                        <q-btn-group>
                    ...
                    <q-card-section class="q-pt-none">
                      <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Status dalam Keluarga</span>
                                <select v-model="form.status_keluarga" class="bg-white"  outlined square :dense="true">
                                    <option v-for="data in $store.state.STATUS_KELUARGA" :key="data._id" :value="data.id">- {{data.uraian}} - </option>
                                </select>
                            </div>
                      ...
                      <div class="tbl_responsive">
                          <table width="100%">
                            ...
                            <tr class="h_table_body">
                              ...
                              <td class=" h_top">Status Keluarga</td>
                              <td class=" h_top">{{form.status_keluarga}}</td>
                            </tr>
                            <tr class="h_table_body">
                              <td class="text-center h_top">3.</td>
                              <td class=" h_top">Tempat, Tgl Lahir</td>
                              <td class=" h_top">{{form.tpt_lahir}}, {{form.tgl_lahir}}</td>
                            </tr>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_srv_desa_riwayatKeluarga + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        formData.append("status_keluarga", this.form.status_keluarga);
        ...
        fetch(this.$store.state.url.URL_srv_desa_riwayatKeluarga + "addData", {
            method: "POST",
            headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_srv_desa_riwayatKeluarga + "editData", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_srv_desa_riwayatKeluarga + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
