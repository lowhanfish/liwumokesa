<template>
    <div>
        <br>
        <q-btn color="red-4" size="sm" icon="add" label="Tambah Data"  @click="mdl_add=true"/>
        <hr class="hrpagin">
        ...
        <table width="100%">
            <tr class="h_table_head bg-grey-5">
                ...
                <th width="30%" class="">Tk Pendidikan / Jurusan</th>
                <th width="35%" class="">Nm Sekolah</th>
                <th width="25%" class=" text-center">Thn Masuk/lulus</th>
                <th width="5%" class=""></th>
            </tr>
            <tr class="h_table_body"  v-for="(data, index) in list_data" :key="data.id">
                <td class="text-center h_top">{{indexing(index+1)}}.</td>
                <td class=" h_top">{{data.masterPendidikanuraian}}/{{data.jurusan}}</td>
                <td class=" h_top">{{data.nm_sekolah}}</td>
                <td class=" h_top text-center">{{data.thn_masuk}} - {{data.thn_lulus}}</td>
                <td class=" h_top">
                    <q-btn-group>
                      ...
                      <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Tingkat Pendidikan</span>
                                <select v-model="form.masterPendidikan" class="bg-white"  outlined square :dense="true">
                                    <option v-for="data in list_pendidikan" :key="data._id" :value="data.id"> [{{data.id}}] {{data.uraian}} </option>
                                </select>
                            </div>

                            <div class="col-12 col-md-12" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Nama Sekolah</span>
                                <q-input v-model="form.nm_sekolah" outlined square :dense="true" class="bg-white margin_btn" /> 
                            </div>

                            <div class="col-12 col-md-12" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">jurusan</span>
                                <q-input v-model="form.jurusan" outlined square :dense="true" class="bg-white margin_btn" /> 
                            </div>


                            <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Tahun Masuk</span>
                                <q-input v-model="form.thn_masuk" outlined square :dense="true" class="bg-white margin_btn" type="number"/> 
                            </div>

                            <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Tahun Selesai</span>
                                <q-input v-model="form.thn_lulus" outlined square :dense="true" class="bg-white margin_btn" type="number"/> 
                            </div>
                            ...
                            <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                                <span class="h_lable ">Lokasi Pendidikan</span>
                      ...
                      <br>
                        <table width="100%">
                          ...
                          <tr class="h_table_body">
                            ...
                            <td class=" h_top">Tingkat pendidikan</td>
                            <td class=" h_top">{{form.masterPendidikanuraian}}.</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">2.</td>
                            <td class=" h_top">Nama Sekolah</td>
                            <td class=" h_top">{{form.nm_sekolah}}.</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">3.</td>
                            <td class=" h_top">Jurusan</td>
                            <td class=" h_top">{{form.jurusan}}.</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">4.</td>
                            <td class=" h_top">Thn Masuk-Lulus</td>
                            <td class=" h_top">{{form.thn_masuk}} - {{form.thn_lulus}}</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">5.</td>
                            <td class=" h_top">Tempat Pendidikan</td>
                            <td class=" h_top">{{form.tpt_pendidikan}}.</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">6.</td>
                            <td class=" h_top">Lokasi Pendidikan</td>
                            <td class=" h_top">{{form.lokasi}}.</td>
                          </tr>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_srv_desa_riwayatPendidikanFormal + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        formData.append("masterPendidikan", this.form.masterPendidikan);
        formData.append("nm_sekolah", this.form.nm_sekolah);
        formData.append("jurusan", this.form.jurusan);
        formData.append("thn_masuk", this.form.thn_masuk);
        formData.append("thn_lulus", this.form.thn_lulus);
        ...
        fetch(this.$store.state.url.URL_srv_desa_riwayatPendidikanFormal + "addData", {
            method: "POST",
            headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_srv_desa_riwayatPendidikanFormal + "editData", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_srv_desa_riwayatPendidikanFormal + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.masterPendidikan= data.masterPendidikan;
        this.form.masterPendidikanuraian= data.masterPendidikanuraian;

        this.form.nm_sekolah= data.nm_sekolah;
