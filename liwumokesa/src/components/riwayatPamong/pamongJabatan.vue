        ...
        <div class="tbl_responsive">
            <table width="100%">
                <tr class="h_table_head bg-grey-5">
                    ...
                    <th width="45%" class="">Nama Jabatan</th>
                    <th width="45%" class="">Periode</th>
                    <th width="5%" class=""></th>
                </tr>
                    ...
                    <q-card-section class="q-pt-none">
                      <br>
                        ...
                        <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                            ...
                            <select v-model="form.masterkelompokPamongJabatan" class="bg-white"  outlined square :dense="true" @change="getList2()">
