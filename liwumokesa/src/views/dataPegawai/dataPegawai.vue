          ...
          <div class="row">
            <div class="col-12 col-md-6" style="padding: 0% 1% 2% 1%">
              <select v-model="form.tahun" @change="cari_data()" class="inputbs">
                ...
                <option v-for="(data, index) in Pangkat" :key="index" :value="data">
                  {{ data.Pangkat }}
                </option>
              </select>
            </div>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    <a
                      ...
                      @click="mdl_lihat = true"
                      >Fajar Syahputra</a
                    >
                  </td>
                  <td class="text-center">19950808202008008</td>
            ...
            <q-card class="mdl-md">
              ...
              <form @submit.prevent="addData()">
                <q-card-section class="q-pt-none">
                  <q-img src="img/user.jpg" spinner-color="primary" spinner-size="82px" />
                  <br /><br />

                  <q-markup-table separator="vertical" flat bordered style="width: 100%">
                    <tr>
                      <td class="text-left" style="width: 30%">Nama</td>
                      <td class="text-left" style="width: 70%">Fajar Syahputra</td>
                    </tr>
                    <tr>
                      <td class="text-left" style="width: 30%">NIP</td>
                      <td class="text-left" style="width: 70%">19950808202008008</td>
                    </tr>
                    <tr>
                      <td class="text-left" style="width: 30%">Jabatan</td>
                      <td class="text-left" style="width: 70%">Kepala Kepala</td>
                    </tr>
                  </q-markup-table>
