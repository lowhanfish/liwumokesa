<template>
  <div class="about" style="padding:15px">
    <q-card bordered class="my-card">
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Carousell</div>
            <div class="text-subtitle2">Slider Web</div>
          </div>
      ...
      <q-card-section>
        <div style="color:#8B8C8C; font-weight:bold; font-size:12px">
          Sangat diharapkan untuk menggunakan ukuran gambar Carousell yang sama
        </div>
        <div style="color:#8B8C8C; font-weight:bold; font-size:12px">Click 
          <a href="http://rodamensa.konaweselatankab.go.id/img/blank.png">disini</a>
          untuk mendownload template blank Carousel
          </div>
        <div class="tbl_responsive" style="padding-top:10px">
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                ...
                <td class="text-center h_top">
                    <span v-if="data.status == 'true'" style="color:green; font-weight:bold; font-size:20px">✔</span> 
                    <span v-if="data.status == 'false'" >❌</span>
                </td>
                <td class="text-center h_top">
                  <q-btn-group>
              ...
              <q-dialog v-model="mdl_add" persistent>
                <q-card class="mdl-md">
                  <q-card-section class="bg-grey-7">
                    <div class="text-h6 h_modalhead">Simpan Data Carausell</div>
                  </q-card-section>

                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        <br>
                        <span class="h_lable ">Judul Foto</span>
               ...
               <q-dialog v-model="mdl_edit" persistent>
                <q-card class="mdl-md">
                  <q-card-section class="bg-orange">
                    <div class="text-h6 h_modalhead">Edit Data Carausell</div>
                  </q-card-section>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_CAROUSELL + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_ADM_CAROUSELL + "addData", {
            method: "POST",
            headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_CAROUSELL + "editData", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_CAROUSELL + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
