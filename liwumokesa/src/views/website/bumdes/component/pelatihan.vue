    ...
    <div class="tbl_responsive">
      <table width="100%">
        <tr class="h_table_head bg-grey-5">
          ...
          <th width="40%">Penyelenggaraan Pelatihan</th>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        <br>
                        <span class="h_lable ">Penyelenggara Pelatihan</span>
                        <q-input v-model="form.penyelenggara" outlined square :dense="true" class="bg-white margin_btn" />
                        <span class="h_lable ">Jenis Pelatihan</span>
                        <q-input v-model="form.jenis" outlined square :dense="true" class="bg-white margin_btn" />
                        <span class="h_lable ">Waktu Pelaksanaan Pelatihan</span>
                        <q-input v-model="form.waktu" type="date" outlined square :dense="true" class="bg-white margin_btn" />
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_srv_bumdes_kelembagaan + "view_pelatihan", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_srv_bumdes_kelembagaan + "addData_pelatihan", {
            method: "POST",
            headers: {
                "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_srv_bumdes_kelembagaan + "editData_pelatihan", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_srv_bumdes_kelembagaan + "removeData_pelatihan", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
