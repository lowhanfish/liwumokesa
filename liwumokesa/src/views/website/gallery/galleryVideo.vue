      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Galery Foto</div>
            <div class="text-subtitle2">Foto Terbaru</div>
          </div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head bg-grey-5">
                ...
                <th width="60%" class="text-center">Judul Foto</th>
                <th width="10%"></th>
              </tr>
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                ...
                <td class="">
                  {{data.judul}} <span class="h_panation">({{data.createdAt}})</span><br/>
                  <span class="h_lable">Repost By : {{data.createdBy}}</span>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_GALLERY_VIDEO + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        this.form.createdAt = UMUM.NOW()
         ...
         fetch(this.$store.state.url.URL_ADM_GALLERY_VIDEO + "addData", {
            method: "POST",
            headers: {
                "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_GALLERY_VIDEO + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_GALLERY_VIDEO + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
