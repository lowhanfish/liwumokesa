        ...
        <q-card-section class="bg-grey-7 text-white">
          <div class="row">
            <div class="col-12 col-md-6">
              <div class="text-h6 h_titleHead">Private Dokumen</div>
  ...
  export default {
    ...
    methods: {
        ...
        getView : function(){
            ...
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "view", {
                method: "POST",
                headers: {
        ...
        // console.log(this.$store.state.listJenisUsaha) 
            ...
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "addData", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData : function(){
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "editData", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        removeData : function(E){
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "removeData", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        getView_file : function(){
            this.$store.commit("shoWLoading");
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "view_file", {
                method: "POST",
                headers: {
                "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
                ...
                body: JSON.stringify({
                    desa_dok_dokumenDesa_id : this.form.id,
                    des_kel : this.form.des_kel,
                })
            })
                .then(res => res.json())
        ...
        addData_file : function(number) {
          ...
          fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "addData_file", {
              method: "POST",
              headers: {
                  // "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
        ...
        editData_file : function(){
          ...
          fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "editData_file", {
            method: "POST",
            headers: {
              // "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
        ...
        removeData_file : function(E){
            fetch(this.$store.state.url.URL_ADM_DESA_DOK_DESA + "removeData_file", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
