      ...
      <q-card-section class="bg-light-green-7 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Data Pegawai</div>
                      ...
                      <br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                            ...
                            <q-input v-model="form.nip" outlined square :dense="true" class="bg-white margin_btn" />
                          </div>

                          <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                            <span class="h_lable ">Pangkat/Golongan</span>
                            <q-input v-model="form.pangkat_gol" outlined square :dense="true" class="bg-white margin_btn" /> 
                          </div>
                    ...
                    <q-card-section class="q-pt-none">
                        ...
                        <table width="100%">
                          ...
                          <tr class="h_table_body">
                            ...
                            <td class=" h_top">NIP</td>
                            <td class=" h_top">{{form.nip}}.</td>
                          </tr>
                          <tr class="h_table_body">
                            <td class="text-center h_top">3.</td>
                            <td class=" h_top">Pangkat/Gol</td>
                            <td class=" h_top">{{form.pangkat_gol}}.</td>
                          </tr>
                          <tr class="h_table_body">
                          ...
                          <tr class="h_table_body">
                            ...
                            <td class=" h_top">{{form.tpt_lahir}} / {{UMUM.tglConvert(form.tgl_lahir)}}.</td>
                          </tr>
                          <tr class="h_table_body">
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_KECAMATAN_DATA_PEGAWAI + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        formData.append("pangkat_gol", this.form.pangkat_gol);
        ...
        fetch(this.$store.state.url.URL_ADM_KECAMATAN_DATA_PEGAWAI + "addData", {
            method: "POST",
            headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_KECAMATAN_DATA_PEGAWAI + "editData", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_KECAMATAN_DATA_PEGAWAI + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
