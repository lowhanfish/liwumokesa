        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <q-btn glossy class="bg-light-blue-10" @click="$router.push('/desa_saranaPenunjang')" dense flat icon="settings" style="width:10%">
...
export default {
  ...
  methods: {
    ...
    getView : async function(){
      var body = this.form
      this.list_data = await CHART.postDataPublish('LayananPenunjang', body);
