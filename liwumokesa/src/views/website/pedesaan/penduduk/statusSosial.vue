      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Data Status Sosial</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head bg-grey-5">
                ...
                <th width="30%" class="">Desa/Kel</th>
                <th width="15%" class="text-center">Jml Kawin</th>
                <th width="15%" class="text-center">Jml Belum Kawin</th>
                <th width="15%" class="text-center">Jml Janda/Duda</th>
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._key">
                ...
                <td class="text-center">{{data.kawin}} Org</td>
                <td class="text-center">{{data.belum_kawin}} Org</td>
                <td class="text-center">{{data.janda_duda}} Org</td>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <span class="h_lable ">Jumlah Kawin</span>
                        <q-input v-model="form.kawin" outlined square :dense="true" class="bg-white margin_btn" type="number" />
                        <div class="inputbs"></div>
                        <span class="h_lable ">Jumlah Belum Kawin</span>
                        <q-input v-model="form.belum_kawin" outlined square :dense="true" class="bg-white margin_btn"  type="number" /> 
                        <div class="inputbs"></div>
                        <span class="h_lable ">Jumlah janda/Duda</span>
                        <q-input v-model="form.janda_duda" outlined square :dense="true" class="bg-white margin_btn"  type="number" /> 
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_STATUS_SOSIAL + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_STATUS_SOSIAL + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_DESA_STATUS_SOSIAL + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_DESA_STATUS_SOSIAL + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.kawin = data.kawin;
        this.form.belum_kawin = data.belum_kawin;
        this.form.janda_duda = data.janda_duda;
