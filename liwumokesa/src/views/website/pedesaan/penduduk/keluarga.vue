      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Data Keluarga</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head bg-grey-5">
                ...
                <th width="15%" class="text-center">Jml KK</th>
                <th width="15%" class="text-center">Jml Pria</th>
                <th width="15%" class="text-center">Jml Wanita</th>
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._key">
                ...
                <td class="text-center">{{data.kk}} Org</td>
                <td class="text-center">{{data.pria}} Org</td>
                <td class="text-center">{{data.wanita}} Org</td>
                    ...
                    <q-card-section class="q-pt-none">
                        <br>
                          <div >
                            ...
                            <br>
                        <span class="h_lable ">Jumlah KK</span>
                        <q-input v-model="form.kk" outlined square :dense="true" class="bg-white margin_btn" />
                        <div class="inputbs"></div>
                        <span class="h_lable ">Jumlah Laki-laki</span>
                        <q-input v-model="form.pria" outlined square :dense="true" class="bg-white margin_btn" /> 
                        <div class="inputbs"></div>
                        <span class="h_lable ">Jumlah Perempuan</span>
                        <q-input v-model="form.wanita" outlined square :dense="true" class="bg-white margin_btn" /> 
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_KELUARGA + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_KELUARGA + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_DESA_KELUARGA + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_DESA_KELUARGA + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.kk = data.kk;
        this.form.pria = data.pria;
        this.form.wanita = data.wanita;
