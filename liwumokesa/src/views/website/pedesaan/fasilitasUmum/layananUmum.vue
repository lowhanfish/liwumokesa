          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._key">
                ...
                <td>{{data.masterFasilitasUmum_uraian}}</td>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <template v-for="(data, index) in $store.state.listFasilitasUmum">
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_FASILITAS_UMUM + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      // console.log(this.$store.state.listFasilitasUmum) 
      this.form.id = uniqid();
      this.form.createdAt = UMUM.NOW();
      fetch(this.$store.state.url.URL_ADM_FASILITAS_UMUM + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
          ...
          body: JSON.stringify({
            form : this.form,
            data : this.$store.state.listFasilitasUmum
          })
      }).then(res_data => {
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_FASILITAS_UMUM + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_FASILITAS_UMUM + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.masterFasilitasUmum = data.masterFasilitasUmum;
    ...
    btnAdd(){
      if (this.form.des_kel == '') {
        ...
        FETCHING.postFasilitasUmum(this.form.tahun, this.form.des_kel)
        this.mdl_add = true
      }
    },
