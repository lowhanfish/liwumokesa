      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Fasilitas Sarana Penunjang</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._key">
                ...
                <td>{{data.masterFasilitasPenunjang_uraian}}</td>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <template v-for="(data, index) in $store.state.listFasilitasPenunjang">
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_FASILITAS_PENUNJANG + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      // console.log(this.$store.state.listFasilitasPenunjang) 
      this.form.id = uniqid();
      this.form.createdAt = UMUM.NOW();
      fetch(this.$store.state.url.URL_ADM_FASILITAS_PENUNJANG + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
          ...
          body: JSON.stringify({
            form : this.form,
            data : this.$store.state.listFasilitasPenunjang
          })
      }).then(res_data => {
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_FASILITAS_PENUNJANG + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_FASILITAS_PENUNJANG + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.masterFasilitasPenunjang = data.masterFasilitasPenunjang;
    ...
    btnAdd(){
      if (this.form.des_kel == '') {
        ...
        FETCHING.postFasilitasPenunjang(this.form.tahun, this.form.des_kel)
        this.mdl_add = true
      }
    },
