                      ...
                      <br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%">
                            ...
                            <select v-model="form.masterkelompokPamongJabatan" class="bg-white"  outlined square :dense="true" @change="getList()">
                              <option value="">-- Pilih Kelompok Pamong --</option>
                              <option v-for="data in list_KelompokPamongJabatan" :key="data.id" :value="data.id">- {{data.uraian}} -</option>
                            </select>
                          </div>
                  ...
                  <q-card-section class="q-pt-none">
                    <br>
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6" style="padding-left:1%; padding-right:1%" v-if="loadJabatan = true">
                            <span class="h_lable ">Pilih Jabatan</span>
                            <q-select
                              v-model="form.masterJenisPamongJabatan"
                              use-input
              ...
              <q-dialog v-model="mdl_lihat" persistent>
                <q-card class="mdl-md">
                  ...
                  <div class="div_row" style="vertical-align: top;">
                    ...
                    <div class="div_col text-center div_top" @click="mdl_pendidikanNonFormal=true">
                        <img class="hoverImg" style="width:100%; height:auto" src="img/i_pendNonFormal.png" alt="">
                        <span class="h_label_icon">Pendidikan Non Formal</span>
                    </div>
                    <div class="div_col text-center div_top" @click="mdl_pendidikanFormal =true">
                        <img class="hoverImg" style="width:100%; height:auto" src="img/i_pendFormal.png" alt="">
                        <span class="h_label_icon">Pendidikan Formal</span>
                    </div>
                    <div class="div_col text-center div_top" @click="mdl_keluarga =true">
                        <img class="hoverImg" style="width:100%; height:auto" src="img/i_keluarga.png" alt="">
                        <span class="h_label_icon">Keluarga</span>
                    </div>
                    <div class="div_col text-center div_top" @click="mdl_prestasi =true">
                        <img class="hoverImg" style="width:100%; height:auto" src="img/i_prestasi.png" alt="">
                        <span class="h_label_icon">Prestasi</span>
                    </div>
                    <div class="div_col text-center div_top" @click="mdl_jabatan_perangkat =true">
                        <img class="hoverImg" style="width:100%; height:auto" src="img/i_pegawai.png" alt="">
              ...
              <q-dialog v-model="mdl_pendidikanNonFormal" persistent>
                <q-card class="mdl-lg">
                  <q-card-section class="bg-purple-3">
                    ...
                    <div class="div_exit_modal">
                      <a @click="mdl_pendidikanNonFormal=false" class="h_clear1 h_exit" href="javascript:void(0);" style="">X</a>
                    </div>
                  </q-card-section>
                    <q-card-section class="q-pt-none">
              ...
              <q-dialog v-model="mdl_pendidikanFormal " persistent>
                <q-card class="mdl-lg">
                  <q-card-section class="bg-red-4">
                    ...
                    <div class="div_exit_modal">
                      <a @click="mdl_pendidikanFormal =false" class="h_clear1 h_exit" href="javascript:void(0);" style="">X</a>
                    </div>
                  </q-card-section>
                    <q-card-section class="q-pt-none">
              ...
              <q-dialog v-model="mdl_keluarga" persistent>
                <q-card class="mdl-md">
                  <q-card-section class="bg-deep-orange-4">
                    ...
                    <div class="div_exit_modal">
                      <a @click="mdl_keluarga =false" class="h_clear1 h_exit" href="javascript:void(0);" style="">X</a>
                    </div>
                  </q-card-section>
                    <q-card-section class="q-pt-none">
              ...
              <q-dialog v-model="mdl_prestasi" persistent>
                <q-card class="mdl-lg">
                  <q-card-section class="bg-lime-7">
                    ...
                    <div class="div_exit_modal">
                      <a @click="mdl_prestasi=false" class="h_clear1 h_exit" href="javascript:void(0);" style="">X</a>
                    </div>
                  </q-card-section>
                    <q-card-section class="q-pt-none">
                       <pamongPrestasi/>
              ...
              <q-dialog v-model="mdl_jabatan_perangkat" persistent>
                <q-card class="mdl-lg">
                  <q-card-section class="bg-red-3">
                    ...
                    <div class="div_exit_modal">
                      <a @click="mdl_jabatan_perangkat=false" class="h_clear1 h_exit" href="javascript:void(0);" style="">X</a>
                    </div>
                  </q-card-section>
                    <q-card-section class="q-pt-none">
                      <pamongJabatan/>
...
export default {
  ...
  methods: {
    ...
    getList2 : async function(){
      ...
      this.list_KelompokPamongJabatan = await FETCHING.FETCH_POST(this.$store.state.url.URL_DATAMASTER_KELOMPOK_PAMONG_JABATAN+ "list_master", bodyx)
