      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Data Jenis Usaha</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._key">
                ...
                <td>{{data.masterJenisUsaha_uraian}}</td>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <template v-for="(data, index) in $store.state.listJenisUsaha">
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_JENIS_USAHA + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      fetch(this.$store.state.url.URL_ADM_DESA_JENIS_USAHA + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
          ...
          body: JSON.stringify({
            form : this.form,
            data : this.$store.state.listJenisUsaha
          })
      }).then(res_data => {
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_ADM_DESA_JENIS_USAHA + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_DESA_JENIS_USAHA + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        ...
        this.form.masterJenisUsaha = data.masterJenisUsaha;
    ...
    btnAdd(){
      if (this.form.des_kel == '') {
        ...
        FETCHING.postJenisUsaha(this.form.tahun, this.form.des_kel)
        this.mdl_add = true
      }
    },
