      ...
      <q-card-section class="bg-grey-7 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Capaian</div>
            <div class="text-subtitle2">Prestasi & Pembangunan</div>
          </div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head bg-grey-5">
                ...
                <th width="70%" class="text-center">Program</th>
                <th width="10%"></th>
              </tr>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <span class="h_lable ">Kategori Capaian</span>
                        <select v-model="form.kategori" class="inputbs">
                        ...
                        <div class="inputbs"></div>
                        <span class="h_lable ">Tahun Capaian</span>
                        <select v-model="form.tahun" class="inputbs">
                          <option v-for="(data, index) in $store.state.tahun" :key="index">{{data}}</option>
                        </select>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_CAPAIAN_KEGIATAN + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        formData.append("keterangan", document.getElementById("editor").value);
        ...
        fetch(this.$store.state.url.URL_ADM_CAPAIAN_KEGIATAN + "addData", {
            method: "POST",
            headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      ...
      fetch(this.$store.state.url.URL_ADM_CAPAIAN_KEGIATAN + "editData", {
          method: "POST",
          headers: {
            // "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_ADM_CAPAIAN_KEGIATAN + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
