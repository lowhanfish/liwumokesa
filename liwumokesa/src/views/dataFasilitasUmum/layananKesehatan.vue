...
export default {
  ...
  methods: {
    getView : async function(){
      var body = this.form
      this.list_data = await FETCHING.postDataPublish(this.$store.state.url.URL_CNT_KECAMATAN_KECAMATAN, 'LayananKesehatan', body);
      console.log(this.list_data)
    },
    chartnya : async function(){
      var body = this.form
      var dataArray = await CHART.postData(this.$store.state.url.URL_CNT_KECAMATAN_DASHBOARD, 'LayananKesehatan', body);
      console.log(dataArray)
      CHART.BarChart('barchartnya', 'Layanan Kesehatan', '', dataArray.uraian , dataArray.jumlah, '')
    },
