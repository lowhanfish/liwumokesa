...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_CNT_DESA_FASILITAS_UMUM + "view", {
          method: "POST",
          headers: {
    ...
    chartnya : async function(){
      ...
      var dataArray = await CHART.postData(this.$store.state.url.URL_CNT_DESA_FASILITAS_UMUM, 'chart', body);
