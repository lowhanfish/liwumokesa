                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <select v-model="dataku.level" class="inputbs">
                          <option v-for="data in list_level" :key="data._id" :value="data._id">{{data.uraian}}</option>
                        </select>

                        <span class="h_lable ">Akses Wilayah</span>
                        <select v-model="dataku.aksesWilayah" @change="setAksesWilayah()" class="inputbs">
                          <option v-for="data in $store.state.aksesWilayah" :key="data.id" :value="data.id">[{{data.id}}] {{data.uraian}}</option>
                        </select>
                        ...
                        <q-input v-model="dataku.password" outlined square :dense="true" class="bg-white margin_btn" /> 

                        <span class="h_lable ">Confirm Password</span>
                        <q-input v-model="dataku.confirmPassword" outlined square :dense="true" class="bg-white margin_btn" /> 
