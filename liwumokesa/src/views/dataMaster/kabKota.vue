      ...
      <q-card-section class="bg-light-green-7 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Kabupaten/Kota</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head bg-grey-5">
                ...
                <th width="30%">Wilayah/Provinsi</th>
                <th width="10%"></th>
              </tr>
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data._id">
                <td class="text-center">{{indexing(index+1)}}.</td>
                <td class="text-center">{{data.wilayah.id}}.{{data.kab_kota.id}}</td>
                <td>{{data.kab_kota.uraian}}</td>
                <td>{{data.wilayah.uraian}}</td>
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <select v-model="form.wilayah" class="inputbs">
                        ...
                        <span class="h_lable ">Nama Kab/Kota</span>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_DATAMASTER_KAB_KOTA + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      fetch(this.$store.state.url.URL_DATAMASTER_KAB_KOTA + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_DATAMASTER_KAB_KOTA + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_DATAMASTER_KAB_KOTA + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
        this.form.id = data.kab_kota.id;
        this.form.wilayah = data.kab_kota.wilayah;
        this.form.uraian = data.kab_kota.uraian;
        this.form.createdAt = data.kab_kota.createdAt;
        this.form.uniqid = data.kab_kota.uniqid;
