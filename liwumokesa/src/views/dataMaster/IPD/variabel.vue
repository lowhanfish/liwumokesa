      ...
      <q-card-section class="bg-orange-4 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Master Variabel</div>
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                            ...
                            <span class="h_lable">Dimensi</span>
                            <select v-model="form.m_ipd_dimensi" class="bg-white margin_btn"  outlined square :dense="true">
                                <option v-for="(data,i) in this.$store.state.listDimensi" :key="data.id" :value="data.id">[{{i+1}}] {{data.uraian}}</option>
                            </select>
                            </div>

                            <div class="col-md-12 col-12">
                            <span class="h_lable">Uraian Variabel</span>
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_srv_ipd_master_variabel + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_srv_ipd_master_variabel + "addData", {
            method: "POST",
            headers: {
                "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
        this.form.keterangan = document.getElementById("editor").value;
      fetch(this.$store.state.url.URL_srv_ipd_master_variabel + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_srv_ipd_master_variabel + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    selectData : function(data){
            ...
            this.form.m_ipd_dimensi = data.m_ipd_dimensi;
    ...
    // ====================================== PAGINATE ====================================
        ...
        tunggu : async function(){
            ...
            const body = {desa : ''};
            this.$store.state.listDimensi  = await FETCHING.FETCH_POST(this.$store.state.url.URL_srv_ipd_master_dimensi + "list", body)
