...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_DATAMASTER_FASILITAS_KESEHATAN + "view", {
          method: "POST",
          headers: {
    ...
    addData : function(number) {
      ...
      fetch(this.$store.state.url.URL_DATAMASTER_FASILITAS_KESEHATAN + "addData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    editData : function(){
      fetch(this.$store.state.url.URL_DATAMASTER_FASILITAS_KESEHATAN + "editData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_DATAMASTER_FASILITAS_KESEHATAN + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
