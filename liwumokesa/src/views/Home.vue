      ...
      <q-card-section class="abuMudaGrad">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Home</div>
            <div class="text-subtitle2">Dashboard {{ $store.state.APP_NAME }}</div>
          </div>
            ...
            <div class="shadow-5 text-center bg-grey-8 frWidgetSub">
              ...
              <div class="text-center">
                <span
                  ...
                  >PEROLEHAN : 0 Suara</span
                >
                <br />
                <span style="font-size: 120%; font-weight: bold; color: white"
                  >PERSENTASE : 0 %</span
                >
              </div>
              <br />
        ...
        <div
          class="col-12 text-center bg-blue-grey-6 padding1-5"
        ...
        <div
          class="col-12 text-center bg-blue-grey-7 padding1-5"
          style="margin-left: 1.5%; margin-right: 1.5%"
        >
        ...
        <div
          class="col-12 text-center bg-yellow-9 padding1-5"
          style="margin-left: 1.5%; margin-right: 1.5%"
        >
...
export default {
  ...
  methods: {
    ...
    LayananPendidikan: async function () {
      ...
      CHART.chartPie(
        "LayananPendidikan",
        "Data Fasilitas Pendidikan (Unit/%)",
        dataArray
      );
    },
    LayananPemerintahan: async function () {
      ...
      CHART.chartPie(
        "LayananPemerintahan",
        "Data Fasilitas Pemerintahan (Unit/%)",
        dataArray
      );
    },
