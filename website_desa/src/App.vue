  ...
  <q-layout view="lHh Lpr lFf">
    ...
    <q-footer reveal elevated class="bg-grey-9" style="margin-top:40%">
        <div class="text-center" style="padding-top:5px; padding-bottom:15px">
            <span class="h_footer1 text-white">WEBSITE {{$store.state.DES_KEL}}</span> <br>
            ...
            <a href="https://web.facebook.com/" style="padding-right:10px" target="_blank">
              <q-avatar> 
                <q-icon name="fab fa-facebook-square" class="text-yellow-10" style="font-size: 32px;" />
              </q-avatar> 
            </a>
            
            <a href="https://wa.me/ /?text=AssalamuAlaikum Lanjutkan,, " target="_blank"> 
              <q-avatar> 
                <q-icon name="fab fa-whatsapp-square" class="text-yellow-10" style="font-size: 32px;" /> 
              </q-avatar>
            </a> 

            <a href="https://www.instagram.com/" style="padding-left:10px" target="_blank">
            <q-avatar> 
              <q-icon name="fab fa-instagram-square" class="text-yellow-10" style="font-size: 32px;" /> 
            </q-avatar> 
            </a>

            <br>
            <span class="h_footer1 text-white">Pengunjung : {{$store.state.VISITOR}}</span> <br>
