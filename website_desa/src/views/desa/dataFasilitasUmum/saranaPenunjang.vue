...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_CNT_DESA_FASILITAS_PENUNJANG + "view", {
          method: "POST",
          headers: {
    ...
    chartnya : async function(){
      ...
      var dataArray = await CHART.postData(this.$store.state.url.URL_CNT_DESA_FASILITAS_PENUNJANG, 'chart', body);
    //   console.log(dataArray)
      CHART.BarChart('barchartnya', 'Sarana Penunjang', 'Data', dataArray.uraian, dataArray.jumlah, 'Unit') 
    },
