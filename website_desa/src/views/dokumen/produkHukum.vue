            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-md-6" style="padding : 0% 1% 2% 1%">
                      <span class="h_title_dok">Produk Hukum</span>
                ...
                <div class="q-pa-md">
                  ...
                  <div class="tbl_responsive">
                    <q-markup-table flat bordered style="width:100%">
                        <thead>
                        ...
                        <tbody>
                            <tr v-for="(data, index) in listData" :key="index"> 
                                ...
                                <td class="text-left h_top">{{data.judul}}  </td>
...
export default {
  ...
  methods: {
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_CNT_DESA_DOK_PRODUK_HUKUM + "view", {
          method: "POST",
          headers: {
