            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="text-center">
                        <span class="h_title text-orange">SURAT KETERANGAN BELUM MEMILIKI RUMAH</span> <br>
                    </div>
                          ...
                          <form>
                              <q-card-section class="q-pt-none">
                                ...
                                <div class="row">
                                  ...
                                  <belumMemilikiRumah :form="form" :uraian='uraian'/>
...
export default {
    ...
    methods: {
        ...
        getView : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketTidakMemilikiRumah + "view", {
              method: "POST",
              headers: {
        ...
        addData : function(number) {
            ...
            fetch(this.$store.state.url.URL_srv_suketTidakMemilikiRumah + "addData", {
                method: "POST",
                headers: {
                    // "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketTidakMemilikiRumah + "editData", {
              method: "POST",
              headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
        ...
        removeData : async function(E){
          ...
          if (confirm) {
            ...
            fetch(this.$store.state.url.URL_srv_suketTidakMemilikiRumah + "removeData", {
                method: "POST",
                headers: {
                  "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
