            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="text-center">
                        <span class="h_title text-orange">SURAT KETERANGAN AHLI WARIS</span> <br>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getView : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketAhliWaris + "view", {
              method: "POST",
              headers: {
        ...
        addData : function(number) {
            ...
            fetch(this.$store.state.url.URL_srv_suketAhliWaris + "addData", {
                method: "POST",
                headers: {
                    // "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketAhliWaris + "editData", {
              method: "POST",
              headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
        ...
        removeData : async function(E){
          ...
          if (confirm) {
            ...
            fetch(this.$store.state.url.URL_srv_suketAhliWaris + "removeData", {
                method: "POST",
                headers: {
                  "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
