            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="text-center">
                        <span class="h_title text-orange">SURAT KETERANGAN USAHA</span> <br>
                    </div>
                                ...
                                <q-card-section class="q-pt-none">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-12 col-md-12 div_input">
                                        ...
                                        <span class="h_label">Jenis Usaha</span>
                                        <q-input outlined v-model="form.jns_usaha" :dense="true" />
                                      </div>


                                      <div class="col-12 col-md-6 div_input div_input_right">
                                        <span class="h_label">Status Tempat Usaha</span>
                                        <q-select v-model="form.status_tpt_usaha" emit-value  map-options option-value="id" option-label="uraian" :dense="true" outlined :options="$store.state.STATUS_TPT_USAHA" label="Status Tempat Usaha" />
                                      </div>


                                      <div class="col-12 col-md-6 div_input div_input_left">
                                        <span class="h_label">Tahun Kepemilikan/Aktif</span>
                                        <q-select filled v-model="form.thn_kepemilikan" :options="$store.state.tahun" label="Aktif Sejak Tahun" :dense="true" outlined/>
                                      </div>


                                      <div class="col-12 col-md-12 div_input">
                                        <span class="h_label">Alamat Usaha</span>
                                        <q-input outlined v-model="form.alamat_usaha" :dense="true" type="textarea"/>
                                      </div>
                              ...
                              <q-card-section class="q-pt-none">
                                ...
                                <div class="row">
                                  <div class="col-12 col-md-12 div_input">
                                      ...
                                      <div class="col-12 col-md-12 div_input div_input_right">
                                        <br>
                                        <hr class="hrdetilberita" />
...
export default {
    ...
    methods: {
        ...
        getView : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketUsaha + "view", {
              method: "POST",
              headers: {
        ...
        addData : function(number) {
            ...
            fetch(this.$store.state.url.URL_srv_suketUsaha + "addData", {
                method: "POST",
                headers: {
                    // "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketUsaha + "editData", {
              method: "POST",
              headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
        ...
        removeData : async function(E){
          ...
          if (confirm) {
            ...
            fetch(this.$store.state.url.URL_srv_suketUsaha + "removeData", {
                method: "POST",
                headers: {
                  "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
        ...
        selectData : function(data){
                ...
                this.form.jns_usaha = data.data.jns_usaha;
                this.form.status_tpt_usaha = data.data.status_tpt_usaha;
                this.form.thn_kepemilikan = data.data.thn_kepemilikan;
                this.form.alamat_usaha = data.data.alamat_usaha;
