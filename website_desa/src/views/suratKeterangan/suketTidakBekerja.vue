            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="text-center">
                        <span class="h_title text-orange">SURAT KETERANGAN BELUM/TIDAK BEKERJA</span> <br>
                    </div>
                      ...
                      <div class="col-12 col-md-12">
                        <q-list bordered padding class="rounded-borders">
                          ...
                          <q-item v-for="data in LIST_DATA" :key="data.data.id" clickable v-ripple @click="selectData(data), modal_lihat =true">
                            ...
                            <q-item-section>
                              <q-item-label lines="1">Surat Keterangan Belum Menikah ({{data.data.nama}})</q-item-label>
                          ...
                          <form>
                              <q-card-section class="q-pt-none">
                                ...
                                <div class="row">
                                  ...
                                  <tidakBekerja :form="form" :uraian='uraian'/>
...
export default {
    ...
    methods: {
        ...
        getView : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketTidakBekerja + "view", {
              method: "POST",
              headers: {
        ...
        addData : function(number) {
            ...
            fetch(this.$store.state.url.URL_srv_suketTidakBekerja + "addData", {
                method: "POST",
                headers: {
                    // "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData : function(){
          ...
          fetch(this.$store.state.url.URL_srv_suketTidakBekerja + "editData", {
              method: "POST",
              headers: {
                // "content-type": "application/json",
                authorization: "kikensbatara " + localStorage.token
        ...
        removeData : async function(E){
          ...
          if (confirm) {
            ...
            fetch(this.$store.state.url.URL_srv_suketTidakBekerja + "removeData", {
                method: "POST",
                headers: {
                  "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
