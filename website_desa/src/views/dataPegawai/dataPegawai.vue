                ...
                <q-markup-table separator="vertical" flat bordered style="width:100%">
                    ...
                    <tbody>
                        <tr v-for="(data, index) in list_data" :key="data.id"> 
                            ...
                            <td class="text-left">
                                <a class="text-black" href="JavaScript:Void(0)" style="text-decoration: none;" @click="selectData(data), mdl_lihat = true" >
                            ...
                            <q-card-section class="q-pt-none">
                                ...
                                <q-markup-table separator="vertical" flat bordered style="width:100%"> 
                                    ...
                                    <tr> 
                                        ...
                                        <td class="text-left" style="width:70%">{{uraian.pendidikan_uraian}}</td>  
                                    </tr>
                                    <tr> 
                                        <td class="text-left" style="width:30%">TTL</td>
                                        <td class="text-left" style="width:70%">{{form.tpt_lahir}}, {{UMUM.tglConvertX(form.tgl_lahir)}}</td>  
                                    </tr>

                                    <tr> 
                                        <td class="text-left" style="width:30%">Agama</td>
                                        <td class="text-left" style="width:70%">{{uraian.agama_uraian}}</td>  
                                    </tr>
