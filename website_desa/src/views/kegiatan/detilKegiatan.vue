        ...
        <div class="col-12 col-md-8">
          <q-card class="my-card">
            ...
            <q-card-section>
              ...
              <!-- <span class="fr-view">{{ $store.state.kegiatan.uraian }}</span> -->

              <hr class="hrdetilberita" />
              <span style="color: grey; font-weight: bold; font-size: 10pt"
                >Share :
              </span>
              ...
              <a
                :href="
                  ...
                  $store.state.url.URL_CLIENT +
                  'detilKegiatan?id=' +
                  $store.state.kegiatan.id
                "
                target="_blank"
              >
                <q-img
