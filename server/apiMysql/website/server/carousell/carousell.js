...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        ...
        UPDATE i WITH `+ reques + ` IN carousell
    `
    // console.log(query)
