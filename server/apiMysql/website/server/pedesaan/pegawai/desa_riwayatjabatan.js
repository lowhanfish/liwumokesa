...
router.post('/view', (req, res) => {
    ...
    var query = `
        ...
        FOR jmlData in pamong_riwayat_riwayatJabatanLainnya
        ...
        let data = (
            FOR datax in pamong_riwayat_riwayatJabatanLainnya
...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into pamong_riwayat_riwayatJabatanLainnya
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in pamong_riwayat_riwayatJabatanLainnya
        FILTER i.id == '`+ req.body.id + `'
        UPDATE i WITH `+ reques + ` IN pamong_riwayat_riwayatJabatanLainnya
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    // console.log(req.body)
    var query = `
        FOR data IN pamong_riwayat_riwayatJabatanLainnya
        filter data.id == '`+ req.body.id + `'
        REMOVE data IN pamong_riwayat_riwayatJabatanLainnya
    `
