...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into desa_dok_perpustakaan_digital
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in desa_dok_perpustakaan_digital
        FILTER i.id == '`+ req.body.id + `'
        UPDATE i WITH `+ reques + ` IN desa_dok_perpustakaan_digital
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    var query = `
        ...
        REMOVE data IN desa_dok_perpustakaan_digital
    `
