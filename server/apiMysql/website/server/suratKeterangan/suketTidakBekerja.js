...
router.post('/viewMaster', (req, res) => {
    ...
    var query = `
        ...
        FOR jmlData in suketTidakBekerja
        ...
        let data = (
            FOR datax in suketTidakBekerja
...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into suketTidakBekerja
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in suketTidakBekerja
        FILTER i.id == '`+ form.id + `'
        UPDATE i WITH `+ reques + ` IN suketTidakBekerja
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    var query = `
        ...
        REMOVE data IN suketTidakBekerja
    `
...
function generateCard (req, res, idz) {
        ...
        var externalURL = urlServer+`cnt_suketTidakBekerja?id=`+IDX
