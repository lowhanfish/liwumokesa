...
router.post('/viewMaster', (req, res) => {
    ...
    var query = `
        ...
        FOR jmlData in suketBerdomisili
...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into suketBerdomisili
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in suketBerdomisili
        FILTER i.id == '`+ form.id + `'
        UPDATE i WITH `+ reques + ` IN suketBerdomisili
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    var query = `
        ...
        REMOVE data IN suketBerdomisili
    `
...
function generateCard (req, res, idz) {
        ...
        var externalURL = urlServer+`cnt_suketBerdomisili?id=`+IDX
