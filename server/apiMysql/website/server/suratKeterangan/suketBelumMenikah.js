...
router.post('/viewMaster', (req, res) => {
    ...
    var query = `
        ...
        FOR jmlData in suketBelumMenikah
        ...
        let data = (
            FOR datax in suketBelumMenikah
...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into suketBelumMenikah
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in suketBelumMenikah
        FILTER i.id == '`+ form.id + `'
        UPDATE i WITH `+ reques + ` IN suketBelumMenikah
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    var query = `
        ...
        REMOVE data IN suketBelumMenikah
    `
...
function generateCard (req, res, idz) {
        ...
        var externalURL = urlServer+`cnt_suketBelumMenikah?id=`+IDX
