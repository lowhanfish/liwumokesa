...
router.get('/', (req, res) => {
    let view = `
        SELECT * FROM suketTidakMemilikiRumah;
    `;
...
router.post('/viewMaster', (req, res) => {
    ...
    var query = `
        ...
        FOR jmlData in suketTidakMemilikiRumah
        ...
        let data = (
            FOR datax in suketTidakMemilikiRumah
...
router.post('/view', (req, res) => {
    ...
    var query = `
        ...
        for data in suketTidakMemilikiRumah
...
router.post('/addData', upload.single("file"), (req, res) => {
    ...
    var query = `
        insert `+ reques + ` into suketTidakMemilikiRumah
    `
    db.query(query)
        .then(cursor => cursor.all())
        .then((row, err) => {
...
router.post('/editData', upload.single("file"), (req, res) => {
    ...
    var query = `
        FOR i in suketTidakMemilikiRumah
        FILTER i.id == '`+ form.id + `'
        UPDATE i WITH `+ reques + ` IN suketTidakMemilikiRumah
    `
    // console.log(query)
...
router.post('/removeData', (req, res) => {
    ...
    var query = `
        ...
        REMOVE data IN suketTidakMemilikiRumah
    `
...
function generateCard (req, res, idz) {
        ...
        var externalURL = urlServer+`cnt_suketTidakMemilikiRumah?id=`+IDX
